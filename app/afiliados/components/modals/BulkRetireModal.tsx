    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md px-6 py-5">
        <h2 className="text-sm font-semibold text-slate-800 mb-2">
          Retirar afiliados seleccionados
        </h2>
        <p className="text-xs text-slate-600 mb-4">
          Vas a retirar <span className="font-semibold">{selectedCount}</span>{" "}
          afiliados. Todos usarán la misma fecha de retiro.
        </p>
