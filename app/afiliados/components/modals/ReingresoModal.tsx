...
type Props = {
  ...
  reingresoDate: string;
  setReingresoDate: (v: string) => void;
  onCancel: () => void;
  onConfirm: () => void;
};

export default function ReingresoModal({
  open,
  afiliado,
  reingresoDate,
  setReingresoDate,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md px-6 py-5">
        ...
        <p className="text-xs text-slate-600 mb-4">
          ...
          . Selecciona la nueva fecha de ingreso.
        </p>
        ...
        <div className="mb-4">
          ...
          <input
            type="date"
            value={reingresoDate}
            onChange={(e) => setReingresoDate(e.target.value)}
